...
func GenerateTopicDescriptions(devices []iotmodel.Device, deviceTypes []iotmodel.DeviceType) (result []topicdescription.TopicDescription) {
	...
	util.ListSort(result, func(a topicdescription.TopicDescription, b topicdescription.TopicDescription) bool {
		return a.GetTopic() < b.GetTopic()
	})
	return result
}

func GenerateDeviceTopicDescriptions(device iotmodel.Device, deviceType iotmodel.DeviceType) (result []topicdescription.TopicDescription) {
...
func GenerateServiceTopicDescriptions(device iotmodel.Device, service iotmodel.Service) (result []topicdescription.TopicDescription) {
...
func GenerateCommandServiceTopicDescriptions(device iotmodel.Device, service iotmodel.Service) (result []topicdescription.TopicDescription) {
	...
	temp := topicdescription.TopicDescription{
		CmdTopic:       cmdTopic,
		RespTopic:      "",
	...
	return []topicdescription.TopicDescription{temp}
}

func GenerateEventServiceTopicDescriptions(device iotmodel.Device, service iotmodel.Service) (result []topicdescription.TopicDescription) {
	...
	return []topicdescription.TopicDescription{{
